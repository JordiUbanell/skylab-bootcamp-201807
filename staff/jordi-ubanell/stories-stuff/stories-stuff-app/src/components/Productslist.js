...
class Producstlist extends Component {
    ...
    render() {
        return (<div>{this.state.products.length > 0 && this.state.products.map((product,index) => {
            return (
              <section>
                {index%2 === 0 ? <div className="container__list-products">
                        <div className="container__list__one-product">
                            ...
                            <div className="object__article__warp">
                                ...
                                <div className="counter_block">
                                    <span className="span__counters"> {product.story.length} {product.story.length > 1 ? 'stories' : 'story'} {product.story.map(story => story.like).reduce((a, b) => a + b, 0)} likes </span>
                    ...
                    <div className="container__list-products">
                        <div className="container__list__one-product--reverse">
                            <div className="figure__warp">
                                <div className="figure__warp__image">
                                    <div className="figure_image">
                                        <Link to={`/post/${product.id}`}><img src={product.photo} /></Link>
