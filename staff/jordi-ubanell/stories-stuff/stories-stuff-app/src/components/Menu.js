...
class Menu extends Component {
    ...
    render() {
        const { onLogout } = this
        logic.loggedIn() && !this.state.userData && this.getData()
                        ...
                        <div className="nav__block__warp">
                            ...
                            {logic.loggedIn() && <div className="nav__block__warp__profile"><div className="section_instructions__icon__box"><Link to="/profile"><img src={icon_profile} /> </Link></div>
                                ...
                                <div className="nav__block__warp__profile__text">
                                    ...
                                    <h5 className="right__text"> <Link to="/profile">{this.state.userData.name}</Link> <br /> <a className="right__text" href="#" onClick={onLogout}>logout </a></h5>
                                    {/* <h5 className="right__text"><a className="right__text" href="#" onClick={onLogout}>logout </a></h5> */}
                                </div>
                            </div>
