...
app.get('/files', (req, res) => {
    ...
    // Alert to get a confirmation to delete a file
    // function deleteAlert() {
    //     var txt;
    //     if (confirm("Sure to delete?!")) {
    //         txt = "File #{file} succesfully deleted";
    //     } 
    // }
...
//     </head>
//     <body>
//         <nav>${sessionUsername} <a href="/logout">logout</a></nav>
//         <ul>
//             ${downloadDeleteFile}
//         </ul>
...
app.post('/register', (req, res) => {
    ...
    try {
        ...
        res.render('register-ok', { session })
...
// Correctly loged and send to files page
